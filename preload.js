...
contextBridge.exposeInMainWorld('api', {
    ...
    checkBrackets: (server, profile) => ipcRenderer.invoke('checkBrackets', server, profile),
    toggleBrackets: (server, profile) => ipcRenderer.invoke('toggleBrackets', server, profile)
});
